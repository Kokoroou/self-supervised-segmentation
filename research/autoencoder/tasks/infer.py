...
def infer(args):
    ...
    # TODO: Find a better way to load checkpoint which is trained on different OS
    # Temporary fix for Windows: Paths saved in checkpoint["args"] are PosixPath, but on Windows we need WindowsPath
